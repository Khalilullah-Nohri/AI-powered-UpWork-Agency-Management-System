...
function Header() {
  ...
  {!isAuthenticated() && (
    <>
      <Link to="/signin" className="ml-4 text-white bg-blue-600 btn hover:bg-blue-700">Sign in</Link>
      <Link to="/signup" className="ml-4 text-white bg-gray-900 btn hover:bg-gray-800">Sign up</Link>
    </>
  )}
